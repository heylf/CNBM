...
// compute correlation (pearson and partial)
public class Correlation {

    //main
    public static void mainCorrelation(String folderPath, String outputPath, String outputPath2,
        ...
        int NumberOfGenes = countLines( folderPath + "/" + listOfFiles[1].getName() ) - 2;

        System.out.println("\n Number of Patients " + NumberOfPatients + "\n");
        System.out.println("\n Number of Genes " + NumberOfGenes + "\n");

        //matrix to save input (gene expression)
        double[][] geneExpMatrix = new double[NumberOfGenes][NumberOfPatients];
        ...
        double[] geneExpMean = new double[NumberOfGenes];
        ...
        float[][] correlationMatrix = new float[NumberOfGenes][NumberOfGenes];
    ...
    public static float partialCorrleation(Float Cor_AB, Float Cor_AC, Float Cor_BC)
    {
        ...
        Float partTwo = (float) Math.sqrt(1 - Math.pow(Cor_AC, 2));
        Float partThree = (float) Math.sqrt(1 - Math.pow(Cor_BC, 2));

        return Math.abs(partOne / (partTwo * partThree) );
