//copied from https://github.com/apache/flink/blob/master/flink-staging/flink-gelly/src/main/java/org/apache/flink/graph/example/CommunityDetection.java.
...
public class CommunityDetection implements ProgramDescription {
    ...
    public static void mainCommunityDetection(String edge, String outpath, Integer maxIt, Double del) throws Exception {
